...
SAFE_TESTS=(
  ...
  "packages/web/test/sapient-webhook.test.ts"
  ...
  "packages/carrier-connectors/test/dpd-connector.test.ts"
  ...
  "packages/rules-engine/test/order-backordered-integration.test.ts"
